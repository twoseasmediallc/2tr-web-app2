/*
  # Add Email Notification Trigger for Custom Rug Orders

  1. Changes
    - Enables pg_net extension for making HTTP requests from database
    - Creates a trigger function that sends order data to the send-order-notification edge function
    - Creates a trigger that fires after INSERT on "Custom Rugs" table
